...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Lenovo\PycharmProjects\calculatorproject'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Lenovo\PycharmProjects\calculatorproject\Scripts\deactivate.nu'
